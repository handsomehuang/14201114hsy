...
public interface GoodsService {
     ...
     * @return 商品列表
     */
    List<Goods> searchGoods(String keywords, int page, int pageSize);
     ...
     * @return 返回商品列表
     */
    List<Goods> listGoods(Shop shop, boolean isonshelves, int page, int pageSize);
