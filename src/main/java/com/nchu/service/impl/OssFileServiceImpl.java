...
public class OssFileServiceImpl implements FileService {
    ...
    public boolean fileDeleteByUrl(String url) {
        ...
        try {
            GenericRequest request = new DeleteObjectsRequest(OssUtil.bucketName).withKey(fileName);
    ...
    private String getFileUrl(String fileName) {
        return OssUtil.endpoint.replaceFirst("http://", "http://" + OssUtil.bucketName + ".") + "/" + fileName;
    }
